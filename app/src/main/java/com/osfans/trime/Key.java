 ...
 */
public class Key  {
    static final int[] KEY_STATE_NORMAL_ON = {
            android.R.attr.state_checkable, android.R.attr.state_checked
    };
    static final int[] KEY_STATE_PRESSED_ON = {
            android.R.attr.state_pressed, android.R.attr.state_checkable, android.R.attr.state_checked
    };
    static final int[] KEY_STATE_NORMAL_OFF = {android.R.attr.state_checkable};
    static final int[] KEY_STATE_PRESSED_OFF = {
            android.R.attr.state_pressed, android.R.attr.state_checkable
    };
    static final int[] KEY_STATE_NORMAL = {};
    static final int[] KEY_STATE_PRESSED = {android.R.attr.state_pressed};
    static final int[][] KEY_STATES =
            new int[][]{
    ...
    static List<String> androidKeys;
    static Map<String, Map> presetKeys;
    ...
    private String hint_right;
    private String hint_bottom;
    private String hint_left;
    ...
    public Key(Keyboard parent, Map<String, Object> mk) {
        ...
        hint_top = Config.getString(mk, "hint_top");
        hint_right = Config.getString(mk, "hint_right");
        hint_bottom = Config.getString(mk, "hint_bottom");
        hint_left = Config.getString(mk, "hint_left");
    ...
    static int getSymbolStart() {
        return symbolStart;
    }

    static void setSymbolStart(int symbolStart) {
    ...
    String getHint_right() {
        return hint_right;
    }

    // 先按原来设计，相当于bottom的符号
    String getHint_bottom() {
        return hint_bottom;
    }
    ...
    Integer getKey_text_size() {
        return key_text_size;
    }

    Integer getSymbol_text_size() {
        return symbol_text_size;
    }

    Float getRound_corner() {
        return round_corner;
    }
    ...
    String getPreviewText(int type) {
